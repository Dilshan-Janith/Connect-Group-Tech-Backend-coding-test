                    ...
                    <div className="flex justify-between h-16">
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavLink href={route('multiple-occurrance.find')} active={route().current('multiple-occurrance.*')}>
                                    Multiple Occurrance
                                </NavLink>
                                <NavLink href={route('group-by-owners.service')} active={route().current('group-by-owners.*')}>
                                    Group By Owners
                                </NavLink>
                            </div>
                        </div>
